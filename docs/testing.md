...
- 三期评估执行 E301-E315：行为基线、Recovery、Delta/Bug freshness、硬门禁负向回归、Finding→Eval→Rule/Gate 晋升、Acceptance/Admission、Worker 边界、Git chronology、Finish 边界、跨框架和人类 Decision 冲突停止。
